      ...
      try {
        const result = await ofetch<Completions>('https://api.openai.com/v1/completions', {
          ...
          body: JSON.stringify({
            ...
            prompt: `Using the provided data emulate this person to answer there questions.
            ...
            if you do not know the answer from the date then state your not sure! you are limited to the scope of the data.
